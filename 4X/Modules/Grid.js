    ...
    $A.extend({
      Grid: function(container) {
            ...
            page: {
              row: {
                      ...
                      if (config.edit && !cellObject.readonly) {
                        if (cellObject.type === "toggle") {
                          ...
                          if (
                            ...
                            $A.isFn(config.page.row.editLoad)
                          )
                    ...
                    "keydown.gridcontrol": function(ev) {
                      ...
                      if (
                        ...
                        if (k === 13 || k === 32) {
                          ...
                          k === 46 &&
                          config.page.row.deleteRow.enabled
                        ) {
                ...
                select: function(cellObject, sv) {
                  var newVal =
                    ...
                    ret =
                      ...
                      $A.isFn(config.page.row.select.cb)
                    ...
                    for (
                      ...
                      if (pos !== -1) {
                        ...
                        if (ret) {
                          ...
                          for (var n in rowObject.cells) {
                            $A(rowObject.cells[n].cellNode).remove();
                          }
                          $A(rowObject.rowNode).remove();
                          var isR = $A.inArray(
                            rowObject.id,
                            config.page.rendered
                          );
                ...
                move: function(o, s) {
                  ...
                  if (
                    ...
                    $A.isFn(config.page.row.move.cb)
                  )
              ...
              sync: function(n) {
                ...
                if (
                  ...
                  if (
                    ...
                    $A.isFn(config.page.indexChanged)
                  )
              ...
              removeRendered: function() {
                ...
                for (var i = 0; i < config.page.rendered.length; i++) {
                  ...
                  if (config.page.on.rem && $A.isFn(config.page.on.rem))
              ...
              render: function(ids) {
                ...
                for (var h = 0; h < ids.length; h++) {
                  ...
                  if (config.page.on.add && $A.isFn(config.page.on.add))
          ...
          for (var ri = 0; ri < rows.length; ri++) {
            ...
            if (!(!row || (isNaN(row.id) && !row.id) || !row.cells)) {
              if (row.id in config.page.row.collection) {
                ...
                $A(config.page.row.collection[row.id].rowNode).remove();
        ...
        that.setDelete = function(o) {
          ...
          if ("callback" in o)
            config.page.row.deleteRow.callback.cb = $A.isFn(o.callback)
              ? o.callback
              : null;
