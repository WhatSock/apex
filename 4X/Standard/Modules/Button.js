  ...
  if (!("setButton" in $A)) {
    $A.extend({
      setButton: function(o, config) {
        ...
        var getState = function(o, attributeValue, hasAttribute, write, nodes) {
            if (hasAttribute) {
              ...
              if (write) {
                ...
                if (attributeValue === "mixed") {
                  $A.remClass(o, config.toggleClassName || "pressed checked");
                  $A.toggleClass(
                    o,
        ...
        $A.query(o, config.context || document, function(i, o) {
          var r =
            ...
            s =
              $A.isNode(r) && !$A.isNative(r) ? r : !$A.isNative(o) ? o : null,
          ...
          if ($A.isNode(s)) {
            ...
            if (($A.isNode(n) && n.required) || config.required || isRequired) {
              $A.setAttr(s, "aria-required", "true");
              if ($A.isNode(n) && !n.required) n.required = true;
            }
            if (($A.isNode(n) && n.disabled) || config.disabled || isDisabled) {
